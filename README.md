...
- 学分情况：
  ...
  - 在 24 级（或许一直都是这样），体育课系统上确实是 0.5 学分 16 学时，但实际上课仍然和大一一样，是 32 学时（16 周课）
...
- 对于不少体育课，若当学期你所在的年级进行了体测，那么大概率在体育课上不用再测 1000 米、引体向上等原本的考核项目，给老师提供体测成绩即可。当然如果对自己的成绩不满意也可以在课上重测（）
...
上课内容主要是短跑爆发力训练、长跑耐力训练、立定跳远技巧训练、引体向上上肢力量训练，针对体测项目重点突破。
运动量不大，一般进行完一项训练就会有 5 ~ 10 分钟的休息时间，且训练很多时候是一个一个进行的（意味着你有很多时间是在等待的）。

2025 秋季学期，何嘉勇老师在本人的大二教学班的具体上课内容大致如下：
  - 几乎每节课前置环节都有的：2 圈慢跑和一系列简单热身运动。
  - 前 4 节课，主要以恢复训练为主，运动量不算大，并会在课上留出时间供大家完成课后跑步作业。
  - 后面 8 节课，围绕体测内容进行训练，助力大家提高体测水平。大概有以下三大内容（有些记不得了）：
    - 耐力训练：6 组 200 米跑和 3 组 300 米跑 + 100 米冲刺跑。这个是最累的一部分。
    - 立定跳远训练
    - 50 米（短跑）训练
  - 最后 4 节课，考试。（在下面“关于成绩”提及）

> 文 / PVZ&X，2026.2

2026年春季学期，体育基础课增加了马克操和起跑器的使用教学。其余上课内容与上文几乎一致。

> 文 / [lin](https://github.com/lin3939)，2026.6
...
- 课后作业（30%）
  ...
  - 在 2025 秋的大二教学班上，何嘉勇老师的作业：前面 7~8 周跑 4 km ，后来过渡到 3 km，最后几周要求为 2 km 。大约在第十周要求有 6.5 min 的配速（不过实际也不管）
- 专项成绩（50%）
...
- 2025 年秋季学期，何嘉勇老师大二教学班的考试内容与上面基本一致。补充一些细节：除俯卧撑和 12 分钟跑，老师说其他项目均按照体测标准评分，但最后本人体测得分比预估高一些；俯卧撑若不标准计数会折半。其余与上面相同，不再赘述。
...
2026年春季学期，体育基础课的考核内容发生了较大改动，具体如下：
- 取消了课后作业的跑步，大家不用再在课下花时间完成跑步作业了。
- 取消了理论考试。
- 增加了马克操和起跑器的使用的考核，按照课上教的规范给分。
- 其余期末考核项目和标准不变。

2026年春的课改之后，体育基础课的上课和考核完全围绕着体能训练和体测来，而且由于取消了课后作业的跑步，平时分基本上只由出勤率决定了，所以千万**不要缺勤**，体育基础班每节课都会点名，缺勤三分之一的课时将会被取消考试资格！
...
- 钱星豪
  - （已离职，悲）
  - 教学内容：
  - 前半节：针对七项身体素质进行训练（速度、柔韧性、耐力、爆发力、协调性、平衡性、力量）。每一项身体素质都有对应的训练项目，有一些比较好玩（如协调），有些强度会很大（如耐力）。
  - 后半节课：橄榄球 / 飞盘比赛
...
- 单人项目 20%：
  ...
  - 2023 秋可以用体测成绩代替
- 小组项目 20%（需提前组五人小组），是七个维度中的五个，团队成员分工，每人完成一项：
  - 速度：50 m×4 折返跑
  - 柔韧：坐位体前屈
  - 耐力：莱格尔跑
  - 力量：引体向上
...
- 倪婧娇
  ...
  - 课上会将同学们分为零基础和有基础两组，有基础的同学学习自由泳，零基础的同学学习蛙泳
    > 文 / [longlin](https://github.com/longlin10086)，2024-03
...
> 文 / [IcyDesert](https://github.com/IcyDesert)，2024-04
...
2024 秋和 2025 春，两门课的理论考试的考核内容都是写一份自己的运动规划。可以查阅资料。
 ...
 **不考长跑！不考引体向上！**
 ...
 注：根据身边同学的反馈，2025 秋大二年级的体育课是要考长跑的，可能和当学期大二学生没有进行体测有关。
...
- 齐冠杰
  ...
  - 学习建议：三路长拳的动作熟悉起来比较难，需要多练习，想拿高分的建议多去b站看看慢动作跟着做几遍。
  - 注意事项：齐老师习惯每节课都开头点名，如果去晚了记得课间补签。
    > 文 / [Maxwell Jay](https://github.com/MaxwellJay256)，2024-08

### 关于考试

1. 理论成绩20% - 老师在学期末会上一次理论课，然后马上做一套卷子。内容包括武术规则、拳法动作、你对武术的理解等。
2. 专项技术50% - 一是考核一些基本的拳法和步法，二是完整的表演一遍三路长拳。据我个人观察，有相当一部分学生在考核时做不出完整的动作。
3. 身体素质30% - 内容、评分标准都和体测一样。如果考核前已经参加过本学期体测，则可以用体测成绩代替，也可申请单独测试。

> 文 / [Maxwell Jay](https://github.com/MaxwellJay256)，2024-08

### 授课地点

大学城体育馆二楼，第一次很容易走错，建议提前15分钟出发，从外面进的那扇门一般不开，要从里面的楼道走上二楼
...
- 第一节课是体能训练，会特别累
- 某一节课会上理论课，课上会考试
- 在学完正手攻球后会给一节课打单打比赛，班内循环打升降机
- 在学完左推右攻后（具体哪一节课不固定）会给一节课打双打比赛，规则仍为升降机。除单打前三不能内部组队外，队友自由选择。
- 剩下的课程都是先跑圈，热身，教新东西（如果有的话），然后就是自由练习。
- 每个动作会有对打任务：反手对打 15 次、 40 次；正手对打 15 次、 40 次；左推右攻 15 组， 40 组；推侧扑 15 组、 40 组。任务完成情况会计入平时分。
...
- 体测：30%
  - 平板支撑（200s 满分）、千米跑、引体向上。在24秋，25春，千米跑和引体向上均可用体测成绩也可以重新再测
- 课程技术：50%
...
- 张冬然
  - 授课内容：
  - 课前会进行热身，有时候热身完会小跑两圈，有时候是让大家玩一些游戏
  - 后面是技术练习时间，以固定搭档传接盘和跑动传接盘为主
  - 一般下半节课就是比赛时间，到下课前十分钟老师会总结比赛情况
    > 文 / [SpeechlessPanda](https://github.com/SpeechlessPanda)，2026-02
...
- 课堂实操：10%
  - 每节课都会点名
- 理论考试：10%
  - 在最后一节课上考，考试内容一般和你对这门课的理解和收获有关，无标准答案，只要认真写基本都能满分。
- 身体素质：30%
  - 1000米跑（男） 800米跑（女）
  - 50米跑
- 专项技术：50%
  - 传接盘：正手连续20个不掉，反手连续30个不掉是满分，中间有一次的保护机制，掉了不中断也不扣分，后面再掉一次扣两分，掉两次扣四分，掉三次就终止，这种情况下以最终连续次数计分。
  - 比赛：随机分队进行比赛，分队会在最终考前几节课就分好，给大家适应时间，过程性评价，不看输赢。

> 文 / [SpeechlessPanda](https://github.com/SpeechlessPanda)，2026-02

### 学习建议

飞盘是一项新兴运动，在我看来它是适合大部分人的。它和其他团队运动不同的特点是它没有裁判，强调自我判罚，以及它追求无身体接触和碰撞，安全性高不少（虽然因为大家都是初学者这一点做的并不是很好 doge）。之所以说它适合大部分人，是因为我个人感觉其实这项运动非常有趣，上手很快而且能体验到团队运动的乐趣。对于想要提高身体素质的人来说，在飞盘比赛中能够如愿以偿，这是一个非常考验体力和身体协调多个方面的过程。对于想要培养体育习惯但不想剧烈运动且想找个容易坚持下来的运动的人来说，可以试试两个人互相固定传接盘的玩法（本人和舍友就买了个飞盘课后玩），既有乐趣又做到了锻炼身体，非常适合从课堂走向大家的日常生活。对于想要单纯混学分的人来说，这门课好上手决定了它考试好过，团队运动决定了它可以划水（bushi）。

不过不可否认的是飞盘比赛确实很吃体力，大家上课的时候注意量力而行。但我觉得并不是体力不好的人就不能报，相反，只要对自己的身体状况有清晰的认知和把握，比赛的时候想要休息都可以申请轮换，老师一般不会在这上面为难大家。

老师人超级超级好，很幽默很有亲和力，目前了解过的那么多体育老师里面给到夯中夯，虽然老师教的另一门课体能训练并不能因此无脑报。给分也超级好，飞盘课是本人体育课中唯一一个最终分数上了90的，而且据我了解老师并不会压学生成绩，相反都是能给就给，并不太管成绩是不是正态分布，非常理解学生的难处，我们班除了极个别上课不来的应该剩下的都有八十分往上。还有张老师本身好像不太会正手接盘（doge），所以到时候可能需要大家自己多摸索尝试，但是通过考试是不难的。BTW，老师还是深圳某合唱团成员。非常有人格魅力的一个老师。

张老师的飞盘课当时成为了我一个星期中可以毫无心理负担玩且能玩的很开心的一段时间，工作日中除了盼望着周末就是飞盘课了，强推！
